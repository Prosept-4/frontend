...
function Position({data, deleteMatchedItems, setPopupOpen, setPopupData}) {
  ...
  return (
    <div className="position">
      ...
      <button className={`position__button-main ${isMainButtonActive && 'position__button-main_active'}`} onClick={handleMainButton}>
      ...
      <div className={`position__item ${isMainButtonActive && 'position__item_active'}`}>
        ...
        <div className="position__container">
          <button className="position__key" onClick={handleCopyProsept}>
