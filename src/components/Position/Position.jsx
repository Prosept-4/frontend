...
function Position({data, deleteMatchedItems, setPopupOpen, setPopupData}) {
  ...
  function handleDelete() {
    deleteMatchedItems(localStorage.getItem('token'), data.id)
  }
  ...
  return (
    <div className="position">
      <div className="position__item">
        ...
        <div className="position__container">
          ...
          <p className="position__price">
            Цена: {data.dealer_product_price}
          </p>
      ...
      <div className={`position__button-main ${isMainButtonActive && 'position__button-main_active'}`} onClick={handleMainButton}>
        <svg className={`position__icon-main ${isMainButtonActive && 'position__icon-main_active'}`} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 32 32">
        ...
        <button type="button" onClick={handleEdit} className={`position__button-edit ${isMainButtonActive && 'position__button-edit_active'}`}>
          <svg className="position__icon-edit" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
          </svg>
        </button>
        <button type="button" onClick={handleDelete} className={`position__button-delete ${isMainButtonActive && 'position__button-delete_active'}`}>
          <svg className="position__icon-delete" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
            <polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
            <line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/>
          </svg>
        </button>
      </div>
      <div className={`position__item ${isMainButtonActive && 'position__item_active'}`}>
        <p className="position__dealer">
          Prosept
        </p>
        <p className="position__name">
        ...
        <div className="position__container">
          <div className="position__key">
            Артикул: <button className="position__article" onClick={handleCopyProsept}>{data.prosept_article}</button>
          </div>
          <p className="position__price">
