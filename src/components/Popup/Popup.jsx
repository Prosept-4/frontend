...
function Popup({
  ...
  function handleMatch() {
    api
      .patchMatch(data.id, data.key, data.dealer_id, productId)
      .then((res) => {
        setMatchedItems((state) =>
          state.map((match) => (match.id === res.id ? (match = res) : match))
        )
      })
      .catch((err) => {
        console.log(err)
  ...
  return (
    <div className={`popup ${isOpen && 'popup_opened'}`}>
      <div className='popup__container'>
        ...
        <div className='popup__column'>{proseptItems}</div>
        <button
          ...
          <svg
            ...
            <g
              ...
              <g
                ...
                <path
                  d='M0.732233047,0.732233047 C1.70854378,-0.244077682 3.29145622,-0.244077682 4.26776695,0.732233047 L34.6733585,31.1378246 C35.6496693,32.1141354 35.6496693,33.6970478 34.6733585,34.6733585 C33.6970478,35.6496693 32.1141354,35.6496693 31.1378246,34.6733585 L0.732233047,4.26776695 C-0.244077682,3.29145622 -0.244077682,1.70854378 0.732233047,0.732233047 Z'
                  id='Rectangle'
                />
                <path
                  d='M0.732233047,34.6733585 C1.70854378,35.6496693 3.29145622,35.6496693 4.26776695,34.6733585 L34.6733585,4.26776695 C35.6496693,3.29145622 35.6496693,1.70854378 34.6733585,0.732233047 C33.6970478,-0.244077682 32.1141354,-0.244077682 31.1378246,0.732233047 L0.732233047,31.1378246 C-0.244077682,32.1141354 -0.244077682,33.6970478 0.732233047,34.6733585 Z'
                  id='Rectangle'
                />
              </g>
            </g>
